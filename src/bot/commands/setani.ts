...
export const data = new SlashCommandBuilder()
	.setName("setani")
	.setDescription("Set your AniList username")
...
export async function execute(
	...
	try {
		...
		await prisma.user.update({
			...
			data: { aniListUsername: username },
		});

		await interaction.editReply({
			embeds: [
				{
					title: "✅ AniList Username Set",
					description: `Your AniList username has been set to **${username}**.`,
